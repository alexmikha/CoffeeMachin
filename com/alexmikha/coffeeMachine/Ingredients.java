...
public class Ingredients {
    ...
    public int checkIngradients() {

        if (map.getOrDefault("coffee", coffee) >= getCoffeeMax() || map.getOrDefault("water", water) >= getWaterMax() ||
                map.getOrDefault("milk", milk) >= getMilkMax() || map.getOrDefault("sugar", sugar) >= getSugarMax()) {
